...
function euler_integrate(fprime::Function, fa::Number, 
	...
	sequence = zeros(1)
	sequence[1] = euler_integrate_step(fprime, fa, a0, h)
	for (i, a) in enumerate(T)
		push!(sequence,  euler_integrate_step(fprime, sequence[i], a, h))
	end
	
	return sequence[2:end]
end
...
@bind N_euler Slider(2:400, show_value = true)
